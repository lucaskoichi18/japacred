...
/**
 * This is the model class for table "tbl_parcelas".
 *
 * The followings are the available columns in table 'tbl_parcelas':
 * @property integer $id
 * @property string $valor
 * @property integer $vencimento
...
class Parcelas extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('id_emprestimo',$this->id_emprestimo);
